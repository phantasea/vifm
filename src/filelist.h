...
//add by sim1 -------
int iter_directory_entries(FileView *view, dir_entry_t **entry);
int iter_nondirectory_entries(FileView *view, dir_entry_t **entry);
int iter_nondotfile_entries(FileView *view, dir_entry_t **entry);
//add by sim1 -------
