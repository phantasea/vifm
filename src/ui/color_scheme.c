...
char *HI_GROUPS[] = {
	...
	[DIALOG_COLOR]       = "Dialog",     //add by sim1
	[TOP_MID_COLOR]      = "TopMid",     //add by sim1
	[LINE_NUM_SEP_COLOR] = "LineNrSep",  //add by sim1
...
const char *HI_GROUPS_DESCR[] = {
	...
	[AUX_CURR_LINE_COLOR]= "cursor in aux window",   //add by sim1
	[TOP_LINE_COLOR]     = "base top line highlight",
	[TOP_LINE_SEL_COLOR] = "active window title",
	[STATUS_LINE_COLOR]  = "status line",
	[WILD_BOX_COLOR]     = "completion window",
	[WILD_MENU_COLOR]    = "current completion item",
	...
	[MENU_COLOR]         = "menu",                   //add by sim1
	[DIALOG_COLOR]       = "dialog",                 //add by sim1
	[TOP_MID_COLOR]      = "top mid filler",         //add by sim1
	[LINE_NUM_SEP_COLOR] = "line number separator",  //add by sim1
...
static const col_attr_t default_cs[] = {
	...
	[AUX_CURR_LINE_COLOR]= { -1,            -1,          A_REVERSE               },  //add by sim1
	...
	[DIALOG_COLOR]       = { COLOR_WHITE,   COLOR_BLACK, A_BOLD                  },  //add by sim1
	[TOP_MID_COLOR]      = { COLOR_WHITE,   COLOR_BLACK, A_BOLD                  },  //add by sim1
	[LINE_NUM_SEP_COLOR] = { -1,            -1,          -1                      },  //add by sim1
