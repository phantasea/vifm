...
void filter_nonratings(view_t *view)
{
	filter_files(view, iter_nonratings_entries);
}
...
void filter_nondirectory(view_t *view)
{
	filter_files(view, iter_nondirectory_entries);
}

void filter_directorys(view_t *view)
{
